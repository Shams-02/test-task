...
export default function SolarPanels() {
  return (
    <div className="p-6 bg-white rounded-3xl flex-1 h-full">
      ...
      <div className="grid lg:grid-cols-5 gap-6 h-fit">
        <div className=" col-span-3 flex flex-col bg-[#FAFAFA] rounded-3xl p-6">
          <div className="">
            <h2 className="text-2xl font-medium text-[#12151A] mb-2 tracking-[0.2px] ">
            ...
            <div className="mb-4">
              <div className="flex items-baseline gap-3 mb-2">
                <span
                  className="text-5xl font-semibold text-[#12151A] tracking-[0.2px] "
                  data-testid="text-annual-production">
                  3,397 kWh
                </span>
                <span className="text-lg text-[#12151A]  tracking-[0.2px] ">
                  annual production
                </span>
              </div>
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <button
                  type="button"
                  className="cursor-pointer flex items-center gap-1 text-sm font-medium text-[#16303D] hover:text-[#91CB50] px-2 py-1 underline underline-offset-4"
                  data-testid="link-product-details">
                  All product details
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    className="text-lg font-normal text-[#12151A]"
                    data-testid="text-panel-specs">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    className="text-lg font-normal text-[#12151A]"
                    data-testid="text-inverter-specs">
          ...
          <div className="">
            <button
              className="cursor-pointer flex items-center gap-1 text-sm font-medium text-[#16303D] hover:text-[#91CB50] px-2 py-1 underline underline-offset-4 mt-8 mb-5"
              data-testid="link-consumption-pattern">
            ...
            <div className="flex items-center gap-2 mt-2 justify-center">
              <div
                className="w-12 h-2"
                style={{ backgroundColor: "#FFE70F" }}></div>
